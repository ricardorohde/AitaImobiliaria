...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <!-- end of column one -->
    <div class="column4">
      <div class="title">Aluguel por Temporada</div>
      <?php
        require "db-conection.php";
        $result = mysqli_query($conexao,utf8_encode("SELECT * FROM imoveis WHERE transacao2 = 'Aluguel Temporada'")) or die(mysql_error());
      ...
      <div class="offer_box_wide"> 
        <a href="imovel.php?idimo=<?php echo $row["id"]; ?>&type=AT">
