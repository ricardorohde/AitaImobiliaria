  ...
  <div id="main_content">
    ...
    <div class="column4">
      ...
      <?php
        ...
        $result = mysqli_query($conexao,utf8_encode("SELECT * FROM imoveis WHERE transacao = 'Aluguel' AND status = 'Ativo'")) or die(mysql_error());
      ...
      <div class="offer_box_wide"> 
        <a href="imovel.php?idimo=<?php echo $row["id"]; ?>&type=A">
