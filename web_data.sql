...
CREATE TABLE caracteristicas_imovel(
	...
	ArmarioEmbutido VARCHAR(255),
	Closet VARCHAR(255),
	DepositoPrivadonoSubsolo VARCHAR(255),
	Despensa VARCHAR(255),
	Escritorio VARCHAR(255),
	EstudaPermuta VARCHAR(255),
	Lareira VARCHAR(255),
	Lavabo VARCHAR(255),
	MeioAndar VARCHAR(255),
	Mobiliado VARCHAR(255),
	QuartoWCEmpregada VARCHAR(255),
	SalaAlmoco VARCHAR(255),
	SalaJantar VARCHAR(255),
	Varanda VARCHAR(255),
	WCEmpregada VARCHAR(255),
	PisoElevado VARCHAR(255),
	CampodeFutebol VARCHAR(255),
	ChildrenCare VARCHAR(255),
	Churrasqueira VARCHAR(255),
	Copa VARCHAR(255),
	EntradadeCaminhoes VARCHAR(255),
	Esquina VARCHAR(255),
	EstacionamentoVisitante VARCHAR(255),
	Frenteparaomar VARCHAR(255),
	Hidromassagem VARCHAR(255),
	Piscina VARCHAR(255),
	Playground VARCHAR(255),
	QuadradeSquash VARCHAR(255),
	QuadradeTenis VARCHAR(255),
	QuadraPoliesportiva VARCHAR(255),
	SalaodeGinastica VARCHAR(255),
	SalaoFestas VARCHAR(255),
	SalaoJogos VARCHAR(255), 
	Sauna VARCHAR(255),
	Vestiario VARCHAR(255),
	imo INT(4),
	FOREIGN KEY (imo) REFERENCES imoveis(id)
);

CREATE TABLE imagens_imo(
	ix INT(4) AUTO_INCREMENT PRIMARY KEY,
	id INT(4),
	name VARCHAR(255), 
	dir VARCHAR(255),
	imo INT(4),
